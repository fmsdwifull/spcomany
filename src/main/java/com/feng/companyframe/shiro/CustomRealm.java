 ...
 * @Author: 冯凡利
 * @UpdateUser: 冯凡利
 * @Version: 0.0.1 com.feng.companyframe.shiro.CustomRealm
 */
public class CustomRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        System.out.print("-----1-----:"+token.getPrincipal());
        System.out.print("-----2-----:"+token.getCredentials());
        System.out.print("-----3-----:"+CustomRealm.class.getName());
